...
import mw.shared.servercommands.ExitCommand;
...
public class ServerCommandSerializerAndDeserializer{
	...
	private ServerCommandSerializerAndDeserializer() {
		...
		aTypeMap.put("BuildWatchtowerCommand", new TypeToken<BuildWatchtowerCommand>(){}.getType());
		...
		aTypeMap.put("FireCannonCommand", new TypeToken<FireCannonCommand>(){}.getType());
		...
		aTypeMap.put("ExitCommand", new TypeToken<ExitCommand>(){}.getType());
		...
		aTypeMap.put("SaveGameCommand", new TypeToken<SaveGameCommand>(){}.getType());
